...
/**
 * Controlador de PA3 · Gestión de departamento.
 *
 * Realiza:
 ...
 *   - Navegación de vuelta a PA2 (empresa) o PA1 (lista de empresas).
 */
public class PA3Controller {
    ...
    /**
     * Recibe el departamento seleccionado desde PA2 y actualiza toda la pantalla.
     * Llamado por PA2Controller después de cargar el FXML y antes de mostrar la escena.
     */
