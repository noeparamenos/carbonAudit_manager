...
public class TestCalculoHuellaDepartamento {
    ...
    public static void main(String[] args) {
        try {
            ...
            dirEmpresa.setProvincia("Madrid");
            dirEmpresa = direccionDAO.create(dirEmpresa);
            System.out.println("✓ Dirección empresa creada:" + dirEmpresa.getCalle() + " - " + dirEmpresa.getNumero());
            ...
            System.out.println("✓ Departamento creado (ID: " + departamento.getIdDepartamento() + "): " + departamento.getNombre());
            ...
            dirEmpleado.setProvincia("Madrid");
            dirEmpleado = direccionDAO.create(dirEmpleado);
            System.out.println("✓ Dirección empleado creada (ID: " + dirEmpleado.getIdDireccion() + ")");
            ...
            System.out.println("OK - Factor emisión creado: " + factorCocheGasolina.getNombre());
            ...
            System.out.println("OK - Empleado creado:" + empleado.getNombre());
            ...
            System.out.println("OK - Consumo creado: " + factorElectricidad.getNombre() + "---" + consumo.getMes() + "/" + consumo.getAnio());
            ...
            BigDecimal esperado = scope2.add(scope3).setScale(2, java.math.RoundingMode.HALF_UP);
            ...
            // ═════════════════════════════════════════════════════════════════════
            System.out.println("🗑️  FASE 3: Limpiando datos de prueba...\n");
